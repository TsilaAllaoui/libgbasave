...
/* FLASH1M_V10x partial verify entry point (VerifyFlashSectorNBytes).
 * This is a distinct public wrapper from VerifyFlashSector and was present in
 * the legacy GBABR exact plan.  Missing it leaves the Nintendo wrapper reading
 * the physical save-chip window after ProgramFlashSectorAndVerifyNBytes. */
const uint16_t flash_v23_verify_n_sig[] = {
  0xb570,          // push {r4, r5, r6, lr}
  0xb0c0,          // sub sp, #256
  0x1c0d,          // adds r5, r1, #0
  0x1c16,          // adds r6, r2, #0
...
const uint32_t flash_v23_verify_n_word0 = 0xb0c0b570;
